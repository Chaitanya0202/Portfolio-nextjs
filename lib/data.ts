...
export const experiencesData = [
  ...
  },
  {
    ...
    location: "",
    description:
      "I have secured a full-time position as a full-stack Web developer at MNNLR . I am excited to apply my skills in solving real-world problems and continuing to enhance my abilities in this dynamic field",
    icon: React.createElement(LuSettings2),
    date: "2024 ",
  },
] as const;
